...
namespace Details {
    ...
    {
    public:
        inline MemberFnWrapper(ResultType (Class::*f)(Args...)) : function_(f) {}

        template<typename This>
        inline ResultType operator ()(This *this_, Args... args) const
        {
            return (this_->*function_)(args...);
        }

        template<typename This>
        inline ResultType operator ()(const std::shared_ptr<This> &this_, Args... args) const
        {
            return (const_cast<This *>(this_.get())->*function_)(args...);
        }
    ...
    {
    public:
        inline ConstMemberFnWrapper(ResultType (Class::*f)(Args...) const) : function_(f) {}

        template<typename This>
        inline ResultType operator ()(const This *this_, Args... args) const
        {
            return (this_->*function_)(args...);
        }
        ...
        inline ResultType operator ()(const std::shared_ptr<This> &this_, Args... args) const
        {
            return (this_.get()->*function_)(args...);
        }
    ...
    template<typename Function> inline Function invokable(Function &f) { return f; }
}
...
public:
    ...
    inline ResultType invoke(Function &f, const RealArgPack &ap)
    {
...
public:
    ...
    inline Arg1 operator [](const Placeholder<1> &) const { return arg1_; }
    template<typename T> inline T &operator [](T &t) const { return t; }
    template<typename T> inline const T &operator [](const T &t) const { return t; }

    template<typename ResultType, typename Function, typename RealArgPack>
    inline ResultType invoke(Function &f, const RealArgPack &ap) const
    {
...
public:
    ...
    inline Arg1 operator [](const Placeholder<1> &) const { return arg1_; }
    inline Arg2 operator [](const Placeholder<2> &) const { return arg2_; }
...
public:
    ...
    inline Arg1 operator [](const Placeholder<1> &) const { return arg1_; }
    inline Arg2 operator [](const Placeholder<2> &) const { return arg2_; }
    inline Arg3 operator [](const Placeholder<3> &) const { return arg3_; }
...
public:
    ...
    inline Arg2 operator [](const Placeholder<2> &) const { return arg2_; }
    inline Arg3 operator [](const Placeholder<3> &) const { return arg3_; }
    inline Arg4 operator [](const Placeholder<4> &) const { return arg4_; }
...
public:
    ...
    inline Arg3 operator [](const Placeholder<3> &) const { return arg3_; }
    inline Arg4 operator [](const Placeholder<4> &) const { return arg4_; }
    inline Arg5 operator [](const Placeholder<5> &) const { return arg5_; }
...
public:
    ...
    inline Arg4 operator [](const Placeholder<4> &) const { return arg4_; }
    inline Arg5 operator [](const Placeholder<5> &) const { return arg5_; }
    inline Arg6 operator [](const Placeholder<6> &) const { return arg6_; }
...
public:
    ...
    inline Arg5 operator [](const Placeholder<5> &) const { return arg5_; }
    inline Arg6 operator [](const Placeholder<6> &) const { return arg6_; }
    inline Arg6 operator [](const Placeholder<7> &) const { return arg7_; }
...
public:
    ...
    inline ResultType operator ()()
    {
        ...
        return pack_.template invoke<ResultType, Function, RealArgs>(func_, RealArgs());
    }
    ...
    inline ResultType operator ()(Arg1 &a1)
    {
        ...
        return pack_.template invoke<ResultType, Function, RealArgs>(func_, RealArgs(a1));
    }

    template<typename Arg1>
    ResultType operator ()(const Arg1 &a1)
    {
    ...
    inline ResultType operator ()(Arg1 &a1, Arg2 &a2)
    {
        ...
        return pack_.template invoke<ResultType, Function, RealArgs>(func_, RealArgs(a1, a2));
    }
    ...
    inline ResultType operator ()(Arg1 &a1, Arg2 &a2, Arg3 &a3)
    {
        ...
        return pack_.template invoke<ResultType, Function, RealArgs>(func_, RealArgs(a1, a2, a3));
    }
    ...
    inline ResultType operator ()(Arg1 &a1, Arg2 &a2, Arg3 &a3, Arg4 &a4)
    {
        ...
        return pack_.template invoke<ResultType, Function, RealArgs>(func_, \
                RealArgs(a1, a2, a3, a4));
    }
...
/* Member functions with shared_ptr this pointer */
